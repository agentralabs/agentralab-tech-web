...
2. `agentra` coordinates sister runtimes (`agentic-codebase-mcp`, `agentic-memory-mcp`, `agentic-vision-mcp`, `agentic-identity-mcp`).
...
2. **Sister runtimes**: `agentic-codebase-mcp`, `agentic-memory-mcp`, `agentic-vision-mcp`, and `agentic-identity-mcp` expose MCP tools.
