...
The MCP server (`agentic-codebase-mcp`) exposes AgenticCodebase to any LLM client that supports the [模型上下文协议](https://modelcontextprotocol.io/).
