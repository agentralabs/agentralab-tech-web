...
- [核心概念](/docs/zh/comm-concepts) -- Understand message types, channels, and communication protocols.
- [API参考](/docs/zh/comm-api-reference) -- Full library API documentation.
- [命令面](/docs/zh/comm-command-surface) -- Complete CLI and MCP tool reference.
- [集成指南](/docs/zh/comm-integration-guide) -- Sister integrations and embedding.
- [基准测试](/docs/zh/comm-benchmarks) -- Performance characteristics.
