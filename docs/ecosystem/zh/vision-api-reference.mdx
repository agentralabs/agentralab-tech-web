---
title: "API参考"
description: "AgenticVision exposes its capabilities through MCP tools, resources, and prompts. 运行 agentic-vision-mcp info to 验证工具发现."
---

AgenticVision exposes its capabilities through MCP tools, resources, and prompts. 运行 `agentic-vision-mcp info` to 验证工具发现.
