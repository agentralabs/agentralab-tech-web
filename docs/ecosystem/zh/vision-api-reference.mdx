---
title: "API参考"
description: "AgenticVision exposes its capabilities through MCP tools, resources, and prompts. 运行 agentic-vision-mcp info to verify tool discovery."
---

AgenticVision exposes its capabilities through MCP tools, resources, and prompts. 运行 `agentic-vision-mcp info` to verify tool discovery.
...
| extract_ocr | boolean | no | false | 运行 OCR on the captured image. |
