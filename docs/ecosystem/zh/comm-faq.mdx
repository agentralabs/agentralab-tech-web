---
title: "Security Hardening and 常见问题"
...
In-process: 2-5 microseconds per message for direct channels. Multi-process (via flush/reload): 10-50 milliseconds. See [基准测试](/docs/zh/comm-benchmarks) for detailed measurements.
...
1. 运行 `acomm compact --older-than 30d` to remove old archived messages and dead letters.
