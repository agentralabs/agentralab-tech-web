---
title: "Rust API 参考"
description: "Complete reference for the agentic_codebase Rust library (v0.2.2). 安装 with cargo add agentic-codebase."
---

Complete reference for the `agentic_codebase` Rust library (v0.2.2). 安装 with `cargo add agentic-codebase`.
