...
| 来源 | 路径 |
|---|---|
| Codebase 规范契约 | `agentic-codebase/docs/ecosystem/CANONICAL_SISTER_KIT.md` |
| Memory 规范契约 | `agentic-memory/docs/ecosystem/CANONICAL_SISTER_KIT.md` |
| Vision 规范契约 | `agentic-vision/docs/ecosystem/CANONICAL_SISTER_KIT.md` |
