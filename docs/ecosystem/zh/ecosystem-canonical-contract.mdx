...
| 来源 | 路径 |
|---|---|
| Codebase 规范契约 | `agentic-codebase/planning-docs/CANONICAL_SISTER_KIT.md` |
| Memory 规范契约 | `agentic-memory/planning-docs/CANONICAL_SISTER_KIT.md` |
| Vision 规范契约 | `agentic-vision/planning-docs/CANONICAL_SISTER_KIT.md` |
