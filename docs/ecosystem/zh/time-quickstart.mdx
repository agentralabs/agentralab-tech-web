...
- [安装](/docs/zh/time-installation) -- profiles and platform details
- [MCP Tools](/docs/zh/time-mcp-tools) -- all 19 tools documented
- [概念](/docs/zh/time-concepts) -- entity types and temporal model
