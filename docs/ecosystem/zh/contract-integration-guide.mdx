...
Plus 16 advanced tools for advanced use cases (see [MCP Tools Reference](/docs/zh/contract-mcp-tools)).
...
See the [FFI Reference](/docs/zh/contract-ffi-reference) for the complete C API.
