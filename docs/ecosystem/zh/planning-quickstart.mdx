...
- 可选: Claude Code for MCP integration
...
- [CLI Reference](/docs/zh/planning-cli-reference) — Full command documentation
- [MCP Tools](/docs/zh/planning-mcp-tools) — All 13 MCP tools with parameters
- [概念](/docs/zh/planning-concepts) — Goal physics, decision crystallization, commitment entanglement
- [集成指南](/docs/zh/planning-integration-guide) — Rust API, Python FFI, WASM patterns
