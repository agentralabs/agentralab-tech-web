...
- [快速开始](/docs/zh/time-quickstart) -- get running in 30 seconds
- [安装](/docs/zh/time-installation) -- all platforms and profiles
- [MCP Tools](/docs/zh/time-mcp-tools) -- full tool reference
- [Architecture](/docs/zh/time-architecture) -- 4-crate workspace structure
