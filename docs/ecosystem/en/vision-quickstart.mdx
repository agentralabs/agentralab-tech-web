---
title: AgenticVision Quickstart (Synced)
description: Generated from agentic-vision/docs/quickstart.md.
---
...
<Callout type="info" title="Source">`agentic-vision/docs/quickstart.md`</Callout>
...
- [Concepts](/docs/vision-concepts) — Understand SiteMap format, feature vectors, acquisition layers
- [API Reference](/docs/vision-api-reference) — Full Python, TypeScript, CLI, REST, and MCP APIs
...
- [Integration Guide](/docs/vision-integration-guide) — MCP setup, framework adapters
