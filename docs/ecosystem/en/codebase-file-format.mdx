---
title: AgenticCodebase File Format (Synced)
description: Generated from agentic-codebase/docs/file-format.md.
---
...
<Callout type="info" title="Source">`agentic-codebase/docs/file-format.md`</Callout>
