---
title: AgenticMemory API Reference (Synced)
description: Generated from agentic-memory/docs/api-reference.md.
---
...
<Callout type="info" title="Source">`agentic-memory/docs/api-reference.md`</Callout>
