---
title: "AgenticContract Overview"
...
- [Quickstart](/docs/en/contract-quickstart) — get started in 5 minutes
- [Concepts](/docs/en/contract-concepts) — core domain model
- [CLI Reference](/docs/en/contract-cli-reference) — full command documentation
- [MCP Tools](/docs/en/contract-mcp-tools) — tool reference for MCP integration
- [Integration Guide](/docs/en/contract-integration-guide) — embedding in your agent
