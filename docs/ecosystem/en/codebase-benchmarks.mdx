---
title: AgenticCodebase Benchmarks (Synced)
description: Generated from agentic-codebase/docs/benchmarks.md.
---
...
<Callout type="info" title="Source">`agentic-codebase/docs/benchmarks.md`</Callout>
