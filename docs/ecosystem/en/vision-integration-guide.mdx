---
title: AgenticVision Integration Guide (Synced)
description: Generated from agentic-vision/docs/integration-guide.md.
---
...
<Callout type="info" title="Source">`agentic-vision/docs/integration-guide.md`</Callout>
