---
title: Ecosystem Canonical Contract (Synced)
...
| Source | Path |
|---|---|
| Codebase canonical contract | `agentic-codebase/docs/ecosystem/CANONICAL_SISTER_KIT.md` |
| Memory canonical contract | `agentic-memory/docs/ecosystem/CANONICAL_SISTER_KIT.md` |
| Vision canonical contract | `agentic-vision/docs/ecosystem/CANONICAL_SISTER_KIT.md` |

## Codebase canonical contract

<Callout type="info" title="Source">`agentic-codebase/docs/ecosystem/CANONICAL_SISTER_KIT.md`</Callout>
...
<Callout type="info" title="Source">`agentic-memory/docs/ecosystem/CANONICAL_SISTER_KIT.md`</Callout>
...
<Callout type="info" title="Source">`agentic-vision/docs/ecosystem/CANONICAL_SISTER_KIT.md`</Callout>
