...
| Source | Path |
|---|---|
| Codebase canonical contract | `agentic-codebase/planning-docs/CANONICAL_SISTER_KIT.md` |
| Memory canonical contract | `agentic-memory/planning-docs/CANONICAL_SISTER_KIT.md` |
| Vision canonical contract | `agentic-vision/planning-docs/CANONICAL_SISTER_KIT.md` |

## Codebase canonical contract

<Callout type="info" title="Source">`agentic-codebase/planning-docs/CANONICAL_SISTER_KIT.md`</Callout>
...
<Callout type="info" title="Source">`agentic-memory/planning-docs/CANONICAL_SISTER_KIT.md`</Callout>
...
<Callout type="info" title="Source">`agentic-vision/planning-docs/CANONICAL_SISTER_KIT.md`</Callout>
