...
description: "AgenticCognition ensures that the runtime behavior matches the install-time promises. This document describes the synchronization contract."
---
...
If any step fails, see [Troubleshooting](/docs/en/cognition-troubleshooting) for platform-specific fixes.
