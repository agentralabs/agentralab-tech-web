...
This exposes the brain as MCP tools that Claude Code, Cursor, Windsurf, and other MCP-compatible editors can connect to. See the [Integration Guide](/docs/en/memory-integration-guide) for configuration details.
