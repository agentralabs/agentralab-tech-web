---
title: AgenticMemory Rust API (Synced)
description: Generated from agentic-memory/docs/rust-api.md.
---
...
<Callout type="info" title="Source">`agentic-memory/docs/rust-api.md`</Callout>
...
This exposes the brain as MCP tools that Claude Code, Cursor, Windsurf, and other MCP-compatible editors can connect to. See the [Integration Guide](/docs/memory-integration-guide) for configuration details.
