...
description: "AgenticCognition exposes its functionality through 14 MCP tools and 40+ CLI commands."
---
...
All commands support `--format json|table|text`, `--storage <path>`, and `--verbose` flags. See [CLI Reference](/docs/en/cognition-cli-reference) for complete details.
