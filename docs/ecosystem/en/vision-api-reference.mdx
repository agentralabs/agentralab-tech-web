---
title: AgenticVision API Reference (Synced)
description: Generated from agentic-vision/docs/api-reference.md.
---
...
<Callout type="info" title="Source">`agentic-vision/docs/api-reference.md`</Callout>
...
See [Integration Guide](/docs/vision-integration-guide) for MCP setup details.
