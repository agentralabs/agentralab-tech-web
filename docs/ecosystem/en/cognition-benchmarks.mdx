---
title: "Benchmarks"
description: "All benchmarks are measured with Criterion (100 samples) on Apple M4 Pro, 64 GB, Rust 1.90.0 --release. No estimates; every number comes from real measured data."
---
