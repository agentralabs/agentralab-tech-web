---
title: "New Sister Rollout Checklist"
description: "Use this page when a new sister is being prepared for public release. It follows the same frame and layout as existing docs. No new UI pane is required."
---
