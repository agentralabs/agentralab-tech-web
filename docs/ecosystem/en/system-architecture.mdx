...
This page explains runtime behavior, boundaries, and deployment flow in plain terms for operators and integrators.
</Callout>
...
## Per-sister architecture pages

- [AgenticMemory Architecture](/docs/memory-system-architecture)
- [AgenticCodebase Architecture](/docs/codebase-system-architecture)
- [AgenticVision Architecture](/docs/vision-system-architecture)
...
The interaction model is intentionally minimal and intent-based.
Detailed command usage is documented in each sister quickstart + integration page.
...
If you expand this section, prioritize:
