---
title: AgenticCodebase Concepts (Synced)
description: Generated from agentic-codebase/docs/concepts.md.
---
...
<Callout type="info" title="Source">`agentic-codebase/docs/concepts.md`</Callout>
