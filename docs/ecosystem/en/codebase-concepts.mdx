---
title: "Core Concepts"
description: "AgenticCodebase models source code as a **typed concept graph** -- a directed, weighted graph where nodes represent discrete code units and edges capture the semantic relationsh..."
---
