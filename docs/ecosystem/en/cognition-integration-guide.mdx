...
The `agentic-cognition-mcp` server exposes 14 tools over the Model Context Protocol. Any MCP-compatible client gains instant access to persistent user modeling. See [MCP Tools](/docs/en/cognition-mcp-tools) for the complete tool reference.
