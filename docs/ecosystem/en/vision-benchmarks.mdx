---
title: AgenticVision Benchmarks (Synced)
description: Generated from agentic-vision/docs/benchmarks.md.
---
...
<Callout type="info" title="Source">`agentic-vision/docs/benchmarks.md`</Callout>
