---
title: AgenticVision Limitations (Synced)
description: Generated from agentic-vision/docs/LIMITATIONS.md.
---
...
<Callout type="info" title="Source">`agentic-vision/docs/LIMITATIONS.md`</Callout>
