...
AgenticPlanning uses operation-based routing for compact MCP tools. Each compact facade takes an `operation` plus optional `params`.
...
Compact list mode: use `MCP_TOOL_SURFACE=compact`.
