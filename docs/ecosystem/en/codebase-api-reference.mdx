...
description: "Complete reference for the `agentic_codebase` Rust library (v0.1.0). Install with `cargo add agentic-codebase`."
---
...
- **[Core Concepts](/docs/en/codebase-concepts)** -- Understand the graph model and query tiers.
- **[Benchmarks](/docs/en/codebase-benchmarks)** -- Performance characteristics at various scales.
