---
title: AgenticCodebase API Reference (Synced)
description: Generated from agentic-codebase/docs/api-reference.md.
---
...
<Callout type="info" title="Source">`agentic-codebase/docs/api-reference.md`</Callout>
...
- **[Core Concepts](/docs/codebase-concepts)** -- Understand the graph model and query tiers.
- **[Benchmarks](/docs/codebase-benchmarks)** -- Performance characteristics at various scales.
