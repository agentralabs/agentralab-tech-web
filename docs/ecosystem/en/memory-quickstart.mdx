---
title: AgenticMemory Quickstart (Synced)
description: Generated from agentic-memory/docs/quickstart.md.
---
...
<Callout type="info" title="Source">`agentic-memory/docs/quickstart.md`</Callout>
...
- **[Core Concepts](/docs/memory-concepts)** -- Understand the cognitive event model, edge semantics, and memory formation pipeline.
- **[Python API Reference](/docs/memory-api-reference)** -- Complete reference for all classes and methods.
- **[Rust API Reference](/docs/memory-rust-api)** -- Rust library and CLI documentation.
- **[Integration Guide](/docs/memory-integration-guide)** -- Connect AgenticMemory to Claude, GPT, LangChain, CrewAI, and MCP servers.
- **[File Format Specification](/docs/memory-file-format)** -- Deep dive into the `.amem` binary format.
- **[Benchmarks](/docs/memory-benchmarks)** -- Performance characteristics at various scales.
- **[FAQ](/docs/memory-faq)** -- Common questions and answers.
