---
title: "Quickstart"
description: "curl -fsSL https://agentralabs.tech/install/memory | bash"
---
...
Profile-specific commands are listed in [Installation](/docs/en/memory-installation).
...
See [Experience With vs Without](/docs/en/memory-experience-with-vs-without) for the full capability map.
