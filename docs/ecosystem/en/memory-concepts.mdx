---
title: "Core Concepts"
description: "AgenticMemory models an AI agent's knowledge as a **cognitive graph** -- a directed, weighted graph where nodes represent discrete cognitive events and edges capture the relatio..."
---
