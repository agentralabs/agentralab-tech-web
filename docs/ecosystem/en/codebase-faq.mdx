...
description: "Language servers (rust-analyzer, pylsp, tsserver) provide real-time IDE features: completions, go-to-definition, diagnostics. They are designed for interactive use and keep the ..."
---
...
See the [API Reference](/docs/en/codebase-api-reference) for the complete library API.
