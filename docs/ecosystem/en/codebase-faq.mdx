---
title: AgenticCodebase FAQ (Synced)
description: Generated from agentic-codebase/docs/faq.md.
---
...
<Callout type="info" title="Source">`agentic-codebase/docs/faq.md`</Callout>
