---
title: AgenticCodebase Integration Guide (Synced)
description: Generated from agentic-codebase/docs/integration-guide.md.
---
...
<Callout type="info" title="Source">`agentic-codebase/docs/integration-guide.md`</Callout>
...
- **[Quickstart Guide](/docs/codebase-quickstart)** -- Get started in 5 minutes.
- **[API Reference](/docs/codebase-api-reference)** -- Complete Rust library reference.
- **[Core Concepts](/docs/codebase-concepts)** -- Understand the graph model.
