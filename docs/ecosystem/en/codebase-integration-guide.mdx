...
description: "This guide covers how to integrate AgenticCodebase into various environments: MCP-compatible AI tools, CI/CD pipelines, custom Rust applications, and the broader Agentic ecosystem."
---
...
- **[Quickstart Guide](/docs/en/codebase-quickstart)** -- Get started in 5 minutes.
- **[API Reference](/docs/en/codebase-api-reference)** -- Complete Rust library reference.
- **[Core Concepts](/docs/en/codebase-concepts)** -- Understand the graph model.
- **[FAQ](/docs/en/codebase-faq)** -- Common questions and answers.
