---
title: AgenticCodebase Quickstart (Synced)
description: Generated from agentic-codebase/docs/quickstart.md.
---
...
<Callout type="info" title="Source">`agentic-codebase/docs/quickstart.md`</Callout>
...
- **[Core Concepts](/docs/codebase-concepts)** -- Understand the graph model, code units, edge semantics, and query tiers.
- **[API Reference](/docs/codebase-api-reference)** -- Complete Rust library reference for all modules and types.
- **[Benchmarks](/docs/codebase-benchmarks)** -- Detailed performance characteristics at various scales.
- **[Integration Guide](/docs/codebase-integration-guide)** -- Connect to MCP clients, CI pipelines, and custom tooling.
- **[FAQ](/docs/codebase-faq)** -- Common questions and answers.
