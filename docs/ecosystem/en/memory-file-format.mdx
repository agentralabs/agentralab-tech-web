---
title: AgenticMemory File Format (Synced)
description: Generated from agentic-memory/docs/file-format.md.
---
...
<Callout type="info" title="Source">`agentic-memory/docs/file-format.md`</Callout>
