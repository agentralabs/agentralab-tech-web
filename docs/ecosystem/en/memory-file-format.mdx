...
description: "This document describes the binary layout of `.amem` files -- the on-disk format for AgenticMemory brain data. The format is designed for fast random access, memory-mapped I/O, ..."
---
