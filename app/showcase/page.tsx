...
export const metadata: Metadata = {
  title: "Showcase",
  description:
    "Public showcase of what teams are building with AgenticMemory, AgenticVision, AgenticCodebase, AgenticIdentity, AgenticTime, AgenticContract, AgenticComm, AgenticPlanning, AgenticCognition, and AgenticReality.",
  ...
  return (
    <div className="min-h-screen dot-grid-bg bg-white">
      ...
      <main>
        ...
        <CommunityRoutingTable step="031" />
      </main>
      <Footer />
    </div>
  )
