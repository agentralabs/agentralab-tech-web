...
export const metadata: Metadata = {
  title: "Showcase",
  description:
    "Public showcase of what teams are building with AgenticMemory, AgenticVision, AgenticCodebase, AgenticIdentity, AgenticTime, AgenticContract, and AgenticComm.",
