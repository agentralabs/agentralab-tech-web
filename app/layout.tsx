...
export const metadata: Metadata = {
  ...
  title: {
    default: 'AGENTRA LABS | AgenticMemory, AgenticVision, AgenticCodebase, AgenticIdentity, AgenticTime, AgenticContract',
  ...
  openGraph: {
    ...
    url: siteConfig.url,
    title: 'AGENTRA LABS | Agentic Systems for Memory, Vision, Code Intelligence, Identity, Temporal Intelligence, and Contract Governance',
    description: siteConfig.description,
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'AGENTRA LABS — AgenticMemory, AgenticVision, AgenticCodebase, AgenticIdentity, AgenticTime, AgenticContract',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'AGENTRA LABS | Memory, Vision, Code Intelligence, Identity, Temporal Intelligence, and Contract Governance',
    description: siteConfig.description,
