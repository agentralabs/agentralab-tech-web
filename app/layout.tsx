...
export const metadata: Metadata = {
  ...
  title: {
    default: 'AGENTRA LABS | AgenticMemory, AgenticVision, AgenticCodebase, AgenticIdentity, AgenticTime, AgenticContract, AgenticComm, AgenticPlanning, AgenticCognition, AgenticReality',
  ...
  openGraph: {
    ...
    url: siteConfig.url,
    title: 'AGENTRA LABS | Agentic Systems for Memory, Vision, Code Intelligence, Identity, Temporal Intelligence, Contract Governance, Communication, Strategic Planning, Cognitive Reasoning, and Existential Grounding',
    description: siteConfig.description,
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'AGENTRA LABS — AgenticMemory, AgenticVision, AgenticCodebase, AgenticIdentity, AgenticTime, AgenticContract, AgenticComm, AgenticPlanning, AgenticCognition, AgenticReality',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'AGENTRA LABS | Memory, Vision, Code Intelligence, Identity, Time, Contract, Communication, Planning, Cognition, and Reality',
    description: siteConfig.description,
