...
export default function RootLayout({
  ...
  const structuredData = [
    ...
    },
    {
      ...
      description: 'Domain-specialist AI model for supply chain management. Gemma 4 fine-tune trained via reasoning-first methodology. Apache 2.0.',
    ...
    },
    {
      ...
      applicationCategory: 'DeveloperApplication',
      operatingSystem: 'macOS, Linux',
      description: 'Domain-specialist AI model for finance and settlement operations. On-premise reasoning with data residency by design. Gemma 4 fine-tune. Apache 2.0.',
    ...
    },
    {
      ...
      applicationCategory: 'DeveloperApplication',
      operatingSystem: 'macOS, Linux',
      description: 'Domain-specialist AI model for financial markets and trading. Consequence reasoning with calibrated confidence. Gemma 4 fine-tune. Apache 2.0.',
