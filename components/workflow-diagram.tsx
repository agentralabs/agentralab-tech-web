...
const LEFT_LABELS = ["Capture", "Compile", "Remember"]
const RIGHT_LABELS = ["Query", "Link", "Act"]
  ...
  return (
    <div className="relative w-full max-w-[800px] mx-auto">
      <svg
        ...
        role="img"
        aria-label="Workflow diagram showing the Agentic stack lifecycle: Capture, Compile, Remember, Query, Link, Act"
      >
