  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 flex flex-col justify-center gap-6 p-6">
        <ScrambleNumber target="16" label="Memory Queries" delay={500} />
        <ScrambleNumber target="10" label="Vision Tools" delay={800} />
        <ScrambleNumber target="24" label="Codebase Queries" delay={1100} />
        <ScrambleNumber target="50+" label="Unified Surface" delay={1400} />
      </div>
    </div>
  )
}
