        ...
        >
          ...
          <div className="absolute top-0 left-0 right-0 z-10 flex items-center justify-between px-4 py-2 bg-foreground/80 backdrop-blur-sm">
            <span className="text-[10px] tracking-[0.2em] uppercase text-background/60 font-mono">
              RENDER: agentic_ecosystem_mesh.obj
            </span>
          ...
          <Image
            src="/images/about-ecosystem-isometric-v2.svg"
            alt="Isometric view of the agentic ecosystem linking memory, vision, and code intelligence"
            fill
          ...
          <div className="flex-1 flex flex-col justify-between px-5 py-6 lg:py-8">
            <div className="flex flex-col gap-6">
              ...
              >
                ...
                <br />
                <span className="text-[#ea580c]">persistent intelligence</span>
              </motion.h2>
              ...
              >
                ...
                <p className="text-xs lg:text-sm font-mono text-muted-foreground leading-relaxed">
                  ...
                  long-running production workflows: browserless mapping,
                  direct action execution, typed compilation, collective deltas,
                  and temporal memory across sessions.
                </p>
              </motion.div>
