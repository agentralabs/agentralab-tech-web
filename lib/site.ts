export const siteConfig = {
  ...
  shortName: "AGENTRA",
  description:
    "Open-source tools that give AI agents persistent memory, visual understanding, code intelligence, and cryptographic identity. AgenticMemory, AgenticVision, AgenticCodebase, and AgenticIdentity work with any MCP-compatible client.",
