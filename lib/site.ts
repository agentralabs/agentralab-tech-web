export const siteConfig = {
  ...
  shortName: "AGENTRA",
  description:
    "Open-source tools that give AI agents persistent memory, visual understanding, code intelligence, cryptographic identity, temporal reasoning, policy governance, structured communication, strategic planning, and cognitive reasoning. AgenticMemory, AgenticVision, AgenticCodebase, AgenticIdentity, AgenticTime, AgenticContract, AgenticComm, AgenticPlanning, and AgenticCognition work with any MCP-compatible client.",
