export const siteConfig = {
  ...
  shortName: "AGENTRA",
  description:
    "Open-source tools that give AI agents persistent memory, visual understanding, code intelligence, cryptographic identity, temporal reasoning, policy governance, and structured communication. AgenticMemory, AgenticVision, AgenticCodebase, AgenticIdentity, AgenticTime, AgenticContract, and AgenticComm work with any MCP-compatible client.",
