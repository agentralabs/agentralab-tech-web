export const siteConfig = {
  ...
  shortName: "AGENTRA",
  description:
    "Open-source tools that give AI agents persistent memory, visual understanding, code intelligence, cryptographic identity, and temporal reasoning. AgenticMemory, AgenticVision, AgenticCodebase, AgenticIdentity, and AgenticTime work with any MCP-compatible client.",
